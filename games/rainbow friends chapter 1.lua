...
--TeleportTab
teleporttab:Button('Theater', function()
...
teleporttab:Button('Waiting Room', function()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(22.5251369, 7.99802494, 331.021362)
end)
